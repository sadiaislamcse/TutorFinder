	...
	<div class="nbody" >
        ...
        <div class="Search">
            ...
            <div class="s_contents">
                ...
                <div class="lc">
                    <p>Location</p>
                    <?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Uttara, Dhaka ">'; ?>
                </div>
                <div class="uni">
                    <p>University</p>
                    <select name="p_university" style="width: 180px;">
						...
						<option value="None">None</option>
						<option value="Dafffodil International University">Dafffodil International University</option>

        ...
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">Daffodil Internation University</div>
              <div class="text-two">Daffodil Smart City, Savar, Dhaka</div>
            </div>
            <div class="phone details">
              <i class="fas fa-phone-alt"></i>
              <div class="topic">Phone</div>
              <br>
              <div class="text-one">01777777777</div>
              <div class="text-two">01999999999</div>
            </div>
            <div class="email details">
              <i class="fas fa-envelope"></i>
              <div class="topic">Email</div>
              <br>
              <div class="text-one">Sadia islam</div>
              <div class="text-two">sadia15-3980@diu.edu.bd</div>
              <br>
              <div class="text-one">Suraiya</div>
              <div class="text-two">suraiya@gmail.com</div>
            </div>
          </div>
          ...
          <form action="mailto:sadia15-3980@diu.edu.bd,suraiya@gmail.com" enctype="text/plain" method="post">
            <div class="input-box">

...
<div class="nbody">
			<?php
				...
				if(isset($success_message)) {echo $success_message;}
					...
					<div class="ac_type">
						<input type="radio" value="teacher" id="radioOne" name="account" checked><p>As a Student</p>
						<input type="radio" value="student" id="radioTwo" name="account"><p>As a Teacher</p>
					</div>
